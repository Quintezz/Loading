/* tests_dispatcher.sql — End-to-end test voor dwh.usp_Dispatch_Load (FULL + INCR_DATE)
   Regels: 2-delige namen, geen @@ROWCOUNT. Alles in 1 transactie met ROLLBACK. */
...
USING (VALUES
 (N'tests.Disp.Full_DimProduct_TEST', N'TST', N'FULL',      N'silver', N'DimProductV2_TEST', N'dwh', N'DimProduct_TEST', N'ProductBK', N'Name',    NULL,     NULL, 1, 1, N'dispatch full test'),
 (N'tests.Disp.IncrDemo_TST',        N'TST', N'INCR_DATE', N'silver', N'IncrDemo_TEST',     N'dwh', N'IncrDemo_TEST',  N'BK',        N'Val',     N'DateCol', NULL, 1, 1, N'dispatch incr test')
